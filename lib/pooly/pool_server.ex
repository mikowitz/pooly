defmodule Pooly.PoolServer do
  ...
  defmodule State do
    defstruct pool_sup: nil, size: nil, mfa: nil,
              worker_sup: nil, workers: nil,
  ...
  def handle_call(:checkout, {from_pid, _ref}, state = %{workers: workers, monitors: monitors}) do
    case workers do
      [worker|rest] ->
  ...
  def handle_info(:start_worker_supervisor, state = %{name: name, pool_sup: pool_sup, mfa: mfa, size: size}) do
